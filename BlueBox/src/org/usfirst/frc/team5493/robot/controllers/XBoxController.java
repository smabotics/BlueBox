...
public class XBoxController extends Joystick implements IDriveJoystick {
	...
	@Override
	public double getTankDriveLeft() {
		return this.getRawAxis(AXS_ONE_LFT_Y);
	}

	@Override
	public double getTankDriveRight() {
		return this.getRawAxis(AXS_FIV_RGT_Y);
	}
